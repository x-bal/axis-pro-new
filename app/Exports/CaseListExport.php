        ...
        if(auth()->user()->hasRole('admin')){
            if ($this->attr['status'] == "All") {
                $case =  CaseList::select('id',
                    ...
                    'wip_usd',
                    'remark',
                    'file_status_id')->whereBetween('instruction_date', [$this->attr['from'], $this->attr['to']])->get();
                ...
                $case = CaseList::select('id',
                        ...
                        'wip_usd',
                        'remark',
                        'file_status_id')->whereBetween('instruction_date', [$this->attr['from'], $this->attr['to']])->where('file_status_id', $status)->get();
            ...
            if ($this->attr['status'] == "All") {
                $case =  CaseList::select('id',
                    ...
                    'wip_usd',
                    'remark',
                    'file_status_id')->where('adjuster_id', auth()->user()->id)->whereBetween('instruction_date', [$this->attr['from'], $this->attr['to']])->get();
                ...
                $case = CaseList::select('id',
                        ...
                        'wip_usd',
                        'remark',
                        'file_status_id')->where('adjuster_id', auth()->user()->id)->whereBetween('instruction_date', [$this->attr['from'], $this->attr['to']])->where('file_status_id', $status)->get();
